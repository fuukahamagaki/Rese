    ...
    public function run()
    {
        ...
        foreach($restaurants as $restaurantData) {
            \App\Models\Restaurant::create([
                ...
                'genre_id' => $restaurantData['genre_id'],
                'area_id' => $restaurantData['area_id'],
